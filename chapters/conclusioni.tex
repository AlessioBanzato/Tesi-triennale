...
\intro{In questo capitolo vengono presentate le conclusioni tratte da questa esperienza di stage. La prima parte del capitolo si concentra sull'organizzazione e gli obiettivi del progetto, mentre la seconda parte è incentrata sulle riflessioni svolte a termine dell'esperienza.}
...
A termine dello stage ho raggiunto tutti gli obiettivi obbligatori esposti nella \sezref{cap:obiettivi} e quasi tutti i desiderabili. Le uniche due attività non svolte sono state la creazione del manuale utente dell'applicazione e la rivisitazione dell'interfaccia grafica per uso su \emph{tablet}, a causa di mancanza di tempo, ma dato che avevano entrambi un basso livello di priorità, il livello di soddisfazione da parte dell'azienda è stato comunque alto.\\
