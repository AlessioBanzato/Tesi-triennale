\chapter{Descrizione dello \textit{stage}}
\label{cap:descrizione-stage}

\intro{Questo capitolo presenta una panoramica sul progetto di \textit{stage}, esponendo in particolare:
\begin{itemize}
    \item un'introduzione al progetto;
    \item i suoi obiettivi;
    \item la pianificazione e lo svolgimento del lavoro.
\end{itemize}
}
