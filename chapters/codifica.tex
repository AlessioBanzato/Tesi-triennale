...
\intro{In questo capitolo verranno esposte in modo approfondito le attività di codifica effettuate nel progetto di stage. Per ogni argomento di codifica verrà esposta la richiesta effettuata dall'azienda, e successivamente l'attività svolta. Al termine del capitolo è presente una breve sezione riguardante i test svolti.}
