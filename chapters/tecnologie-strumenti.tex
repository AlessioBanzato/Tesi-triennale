...
\begin{itemize}
    ...
    \item \textbf{Utilizzo}: implementazione delle \acrog{api} e scrittura del \glox{code-behind}.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Utilizzo}: implementazione delle \acrog{api} e \glox{code-behind}.
\end{itemize}
